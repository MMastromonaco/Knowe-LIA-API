...
namespace KnoweLia.Controllers
{
    ...
    {
        private readonly LiaContext _context;

        public UsersController(LiaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Users != null ? 
                          ...
                          Problem("Entity set 'LiaContext.Users'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LiaContext.Users'  is null.");
            }
            var user = await _context.Users.FindAsync(id);
            if (user != null)
            {
